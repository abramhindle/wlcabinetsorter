...
import appdirs
import argparse
from wlcabinetsorter.app import App

if __name__ == '__main__':

    # Figure out a default INI file location if we weren't passed anything
    default_config_file = os.path.join(
            appdirs.user_config_dir('wlcabinetsorter', 'Apocalyptech'),
            'wlcabinetsorter.ini',
            )

    parser = argparse.ArgumentParser(
            description='BLCM WL ModCabinet Auto-Sorter',
            ...
            epilog="""
                ...
                `wlcabinetsorter.ini.example` as a basis for the file.
